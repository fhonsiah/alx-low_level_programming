/*
 *Program:8_24_hours.c
 *Afunction that prints every minute of the day of Jack Bauer,starting from
 *00:00 to 23:59.
 ...
 *
 *Retrun:the retrun type is void i.e does not return anything.
 *
 */
